...
namespace CapaDatos
{
    public class CDConexion
    {
        ...
        public SqlConnection Conexion = new SqlConnection("Data Source=10.40.95.70;Initial Catalog=DBFIGUE2;User ID=sa;Password=123;MultipleActiveResultSets=true;");
