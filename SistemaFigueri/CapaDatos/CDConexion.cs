...
namespace CapaDatos
{
    public class CDConexion
    {
        ...
        public SqlConnection Conexion = new SqlConnection("Data Source=192.168.0.100;Initial Catalog=DBFIGUE2;User ID=sa;Password=123;MultipleActiveResultSets=true;");
